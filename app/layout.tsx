...
export const metadata: Metadata = {
  title: "Vouch — Find the revenue hiding in your data",
  description:
    "Vouch is an open-source tool that turns the CSVs and exports you already have into clear, actionable revenue insights.",
};
