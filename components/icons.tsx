...
export function SparkleIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      ...
      <path d="M19 15c.3 1.6 1 2.4 2.6 2.7-1.6.3-2.3 1-2.6 2.6-.3-1.6-1-2.3-2.6-2.6 1.6-.3 2.3-1.1 2.6-2.7Z" />
    </svg>
  );
}
